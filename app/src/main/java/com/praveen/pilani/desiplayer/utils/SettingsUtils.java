...
public class SettingsUtils {
    ...
    private static final String ACCENT_PREF = "com.praveen.pilani.desiplayer.pref_accent";
    private static final String ACCENT_VALUE = "com.praveen.pilani.desiplayer.pref_accent_value";
    private static final String THEME_PREF = "com.praveen.pilani.desiplayer.pref_theme";
    private static final String THEME_VALUE = "com.praveen.pilani.desiplayer.pref_theme_value";
